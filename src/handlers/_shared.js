...
function buildAccountInfoBasic(acc) {
  ...
  return {
    ...
    cs_rank: acc.cs_rank || 1,
    cs_ranking_points: acc.cs_ranking_points || 0,
    max_rank: acc.max_rank || acc.rank || 1,
    cs_max_rank: acc.cs_max_rank || acc.cs_rank || 1,
    peak_rank_pos: acc.peak_rank_pos || 0,
    cs_peak_rank_pos: acc.cs_peak_rank_pos || 0,
    role: acc.role || 0,
